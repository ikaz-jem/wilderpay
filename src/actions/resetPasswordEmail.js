...
export async function resetPasswordEmail(email, token) {
  ...
  const verificationUrl = `https://wilderpay.com/verification?token=${token}`;
                        ...
                        <tr>
                          <td>
                            ...
                            <p
                              ...
                              Finish Your wilderpay account Validation
                        ...
                        <tr>
                          <td>
                            <p
                              ...
                              wilderpay  will never email you and ask
