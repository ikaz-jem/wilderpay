...
export default async function DashboardLayout({ children }) {
    ...
    return (
        <div  className=' h-full    flex justify-between items-center flex-col transition-all' >
            ...
            <div className='bg-[url(/assets/images/bg.png)] bg-cover bg-no-repeat bg-center w-full h-full fixed top-0 z-[-1] grayscale-40 opacity-80 mix-blend-color-overlay mask-radial-to-30% md:mask-radial-to-50% lg:mask-radial-to-60% duration-[ 20s]'>
            </div>
