...
export default async function DashboardLayout({ children }) {
    ...
    return (
        <div  className=' h-full overflow-hidden   flex justify-between items-center flex-col transition-all' >
            ...
            <div className='bg-[url(/assets/images/3.png)] bg-contain bg-no-repeat bg-center w-[80vw] h-[450px] absolute top-0 z-[-1] grayscale-40 opacity-60 mask-b-from-0 mix-blend-color-overlay'>
            </div>
