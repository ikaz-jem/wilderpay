...
const url = "https://www.yieldium.app/login";
  ...
  <table align="center" width="100%" style="max-width: 600px; margin: auto; padding: 20px;">
    ...
    <tr>
      <td style="background-color: #1A1A2E; border-radius: 10px; padding: 30px;">
        ...
        <!-- Heading -->
        <h1 style="font-size: 24px; color: #45E3FF; margin: 0 0 20px;">Password Reset Request</h1>

        <!-- Intro -->
        <p style="font-size: 16px; color: #CCCCCC; margin: 0 0 20px;">
          Please Use The Following one Time Password To Login And Reset Your Password under Settings Tab:
        </p>
    ...
    <td style="text-align: center; padding: 20px 0; font-size: 12px; color: #777;">
      <b>Disclaimer:</b>
      Please check with the receiving platform or wallet as the transaction is already confirmed on the blockchain
      explorer.
      <br />
    </td>
    ...
    <tr>
      <td style="text-align: center; padding: 20px 0; font-size: 12px; color: #777;">
        ...
        Warning.
        <b> Kindly note:</b>
        Please be aware of phishing sites and always make sure you are visiting the official
        <span style="color: #45E3FF; text-decoration: none;">yieldium.app</span>
